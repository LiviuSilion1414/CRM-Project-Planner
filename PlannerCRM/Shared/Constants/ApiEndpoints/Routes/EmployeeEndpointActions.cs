...
public class EmployeeEndpointActions
{
    ...
    public const string FIND_ASSOCIATED_ACTIVITIES_BY_EMPLOYEEID = "findAssociatedActivitiesByEmployeeId/{item1}";
    public const string FIND_ASSOCIATED_WORKTIMES_BY_ACTIVITYID_AND_EMPLOYEEID = "findAssociatedWorkTimesByActivityIdAndEmployeeId/{item1}/{item2}";
    public const string FIND_ASSOCIATED_SALARY_DATA_BY_EMPLOYEEID ="findAssociatedSalaryDataByEmployeeId/{item1}";
